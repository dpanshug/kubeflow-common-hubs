    ...
    <div className="mt-2 space-y-2">
      ...
      <div className="grid grid-cols-2 gap-1">
        {checks.map((check) => (
          <span
            key={check.label}
            className={`text-[11px] ${check.met ? "text-green-400" : "text-text-muted"}`}
          >
    ...
    <div className="rounded-xl border border-border bg-bg-secondary p-6 sm:p-8 shadow-lg">
      ...
      <div className="flex flex-col gap-3 mb-6">
        <button
          ...
          disabled={isPending}
          className="flex items-center justify-center gap-3 w-full px-4 py-2.5 rounded-lg border border-border bg-bg-primary text-sm font-medium text-text-primary hover:bg-bg-tertiary transition-colors disabled:opacity-50"
        >
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-bg-secondary px-2 text-text-muted">or sign up with email</span>
        </div>
      </div>
      ...
      <p className="mt-6 text-center text-sm text-text-secondary">
        ...
        <Link href="/login" className="text-[var(--kf-blue)] font-medium hover:underline">
          Sign in
        </Link>
      </p>
    </div>
