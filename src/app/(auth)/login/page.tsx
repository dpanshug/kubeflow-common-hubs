    ...
    <div className="rounded-xl border border-border bg-bg-secondary p-6 sm:p-8 shadow-lg">
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-bg-secondary px-2 text-text-muted">or sign in with email</span>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
        ...
        <div className="flex items-center justify-end">
          <Link
            ...
            className="text-xs text-[var(--kf-blue)] hover:underline"
          >
            Forgot password?
          </Link>
        </div>
      ...
      <p className="mt-6 text-center text-sm text-text-secondary">
        ...
        <Link href="/signup" className="text-[var(--kf-blue)] font-medium hover:underline">
          Join the community
        </Link>
      </p>
    </div>
